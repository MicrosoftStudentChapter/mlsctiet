...
function Event1() {
  ...
  const yearWiseData = {
    22: {
      1: [
        "Makeathon 4.0",
        "The Microsoft Learn Student Chapter team was back with its most-awaited, annual flagship event MAKEATHON 4.0. Since its inception three years ago MAKEATHON has unquestionably established as one of the most known hackathons of North India, as well as Thapar Institute of Engineering and Technology turning out to be it’s first MLH sponsored hackathon. With the dedicated effort of the members of the society, a 24-hour hybrid hackathon with more than 1500 registrations and 300 participating teams in online and offline, and bootcamp which included eminent speakers was successfully completed. 50+ sponsors helped us bag prizes in the form of monetary prizes, goodies, swags, premium courses and a lot more.",
      ],
      2: [
        "CP contest 2022",
        "CP contest was the first iteration of the monthly intra MLSC CP Contest to nurture the coding and technical culture. The competition offered all the technophiles a competitive environment and let the contestants demonstrate their logical and analytical abilities. The questions were designed to put their knowledge to the test and give them a taste of competitive coding. Three victors emerged as the clear leaders in the competition.",
      ],
      3: [
        "Ideathon 2022",
    ...
    <div className={styles.body}>
      <div>
        <div className={styles.back}>
          {!remSub ? (
            <Backsvg rem={false} mob={isMobile} />
          ) : (
            <Backsvg rem={true} mob={isMobile} />
          )}
        </div>
      </div>
        ...
        {!remSub && (
          <div className={styles.footer}>
            <div className={styles.text}>
              ...
              <div className={styles.subhead}>@ MLSC</div>
            </div>
          </div>
        )}
      </div>
