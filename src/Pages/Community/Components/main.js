      ...
      <div className={styles.headingContainer}>
        ...
        <div className={styles.contentContainer}>
          ...
          <div className={styles.right}>
            <p>
              We are a group of highly motivated learners and seekers who wish
              to create something extraordinary. We believe that youth
              encompassed with appropriate technology holds the potential to
              revolutionize the world we perceive today. With our Open-Source
              community, we aim to bring together the aspiring minds and create
              a space where they can learn, grow and develop together. To foster
              this process, we conduct various seminars, group discussions and
              talks on our channel. It also serves as a platform for the
              multitude hackathons, coding events we conduct throughout the year
              and the projects we develop.
            </p>
            ...
            <div className={styles.buttons}>
              <button className={styles.joinButton}>
                <a
                  className={styles.joinButtonCss}
                  href="https://discord.gg/hbNeZtS62D"
                >
                  Join the Community
              ...
              <button className={styles.joinButton2}>
                <a
                  className={styles.joinButtonCss}
                  href="https://in.linkedin.com/company/microsoft-learn-student-chapter"
                >
                  <img
              ...
              <button className={styles.joinButton2}>
                ...
                >
                  <img
                    className={styles.linkedin}
                    src="https://www.pngkey.com/png/full/107-1075251_la-instagram-logo-white-png-circle.png"
                  />
                </a>
              </button>
            </div>
