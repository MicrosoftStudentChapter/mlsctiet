  ...
  <div className={styles.main}>
      ...
      >
        ...
        <div className={styles.carousel1}>
          ...
          <div className={styles.container1}> 
            <img className={styles.spnsrlogo1} src={cnlogo} alt="Coding Ninjas"></img>
          </div>

          <div className={styles.containerSpace}></div>
        
          <div className={styles.container2}>
            <h2 classname={styles.sponsorText}>Coding Ninjas</h2>
    ...
    <div className={styles.whysponsorus}>
      ...
      <p className={styles.sponsorPara}>
        ...
        The Youth hub of the organization is a huge reach, as it has a large student population of 10000+ people on campus.</p>

      {/* Second Para */}
 
      <p className={styles.sponsorPara}> 
        <span className={styles.sponsorText}>Connecting Tech Enthusiasts all over India:&nbsp;</span>
        MLSC is an Open-Source community that connects tech enthusiasts all across India. Its discord server has a reach of over a thousand people, which includes members from some of the country's most prominent educational institutions such as IITs and NITs.</p>

      {/* Third Para */}

      <p className={styles.sponsorPara}>
        <span className={styles.sponsorText}>Flagship Events:&nbsp;</span>
        MLSC is known for conducting various events throughout the year, which are designed to reach a massive audience. Some of these being Abhyudaya and Makeathon, which are very popular annual events that have the potential to increase the awareness and reach of your brand.</p>

      {/* Fourth Para */}

      <p className={styles.sponsorPara}>
        <span className={styles.sponsorText}>Ultimate Social Media Reach:&nbsp;</span>
        MLSC has an extensive social media presence that includes over 8000 followers on various platforms such as Facebook, Instagram, and LinkedIn. Thus strategically helping boost your brand's reputation, reach and attract the youth.
      </p>

      <p className={styles.sponsorPara}>
        <span className={styles.sponsorText}>Best way to kickstart your campaign:&nbsp;</span>
        Collaborating with MLSC, a group of over a hundred individuals who are dedicated to learning all the traits that make up a successful team will help you organize various promotional events and learning workshops.
      </p>
    ...
    <h1 className={styles.sponsorUsHead}>Want To Sponsor Our Upcoming Event?</h1>
